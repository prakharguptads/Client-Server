...
public class ChatServer extends JFrame implements Runnable{
...

	{
		...
		p1.setBorder(BorderFactory.createTitledBorder("ChatServer"));
		ta1.setEditable(false);
		Name = JOptionPane.showInputDialog(null, "Enter Name"); // user se name poochega n name m store ho jaega 
		L1.setText(Name); // name se l1 lable m aa jaega
